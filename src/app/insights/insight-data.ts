...
export const insights: Insight[] = [
  {
    ...
    alt: "Technology support colleagues assessing a shared workstation",
    intro:
    ...
    serviceSlug: "managed-it-support",
    serviceLabel: "Managed IT Support",
    sections: [
      {
        heading: "Begin with the outcome, not the supplier change",
        paragraphs: [
      ...
      {
        heading: "Build an accurate picture of the environment",
        paragraphs: [
      ...
      {
        heading: "Protect access without passing risk forward",
        paragraphs: [
      ...
      {
        heading: "Plan continuity for users",
        paragraphs: [
      ...
      {
        heading: "Treat onboarding as the start of improvement",
        paragraphs: [
  ...
  },
  {
    ...
    alt: "Technology specialists working across an office support environment",
    intro:
    ...
    sections: [
      {
        heading: "Start with the organisation and its priorities",
        paragraphs: [
      ...
      {
        heading: "Review identity and access",
        paragraphs: [
      ...
      {
        heading: "Understand devices and everyday protection",
        paragraphs: [
      ...
      {
        heading: "Examine cloud services, email and information sharing",
        paragraphs: [
      ...
      {
        heading: "Test the assumptions behind backup and recovery",
        paragraphs: [
      ...
      {
        heading: "Turn findings into an owned plan",
        paragraphs: [
  ...
  },
  {
    ...
    alt: "Two colleagues planning work together across laptops",
    intro:
      "A cloud migration is successful when the technology moves and the organisation continues to work. That requires attention to users, data, access and operational timing, not only the destination platform.",
    readingTime: "7 minute read",
    serviceSlug: "cloud-microsoft-365",
    serviceLabel: "Cloud & Microsoft 365",
    sections: [
      {
        heading: "Define the reason for moving",
        paragraphs: [
          "Cloud migration should be connected to a clear business need. Moving because a platform is fashionable makes it difficult to judge scope, priority or success.",
          "Useful drivers may include collaboration, secure remote access, resilience, reduced infrastructure dependency or the need to support growth. Documenting these reasons helps the project avoid technical activity that does not improve the intended outcome.",
        ],
        points: [
          "What should become easier for users?",
          "Which risk or limitation is being addressed?",
          "What must remain available throughout the change?",
          "How will the organisation know the migration worked?",
        ],
      },
      {
        heading: "Map applications, data and dependencies",
        paragraphs: [
          "Systems rarely operate in isolation. An application may depend on identity, shared storage, integrations, network access or a particular device configuration. Moving one part without understanding those connections can create disruption elsewhere.",
          "Build a practical dependency map and identify owners who understand how each service is used. Technical inventory and user knowledge are both required.",
        ],
        points: [
          "Applications, data stores and integrations",
          "Identity and permission dependencies",
          "Network, device and printing requirements",
          "External suppliers and support arrangements",
          "Peak periods and business-critical workflows",
        ],
      },
      {
        heading: "Decide what should move and what should not",
        paragraphs: [
          "Not every workload needs to move at the same time or to the same destination. Some systems may need improvement before migration, while others may be replaced, retired or retained temporarily.",
          "A phased decision reduces unnecessary scope and gives the team a clearer sequence. It also creates a place to record constraints rather than allowing them to emerge late in delivery.",
        ],
        points: [
          "Move, improve, replace, retain or retire each workload.",
          "Identify data that needs cleaning or ownership decisions.",
          "Confirm licensing and technical compatibility.",
          "Document security and compliance requirements.",
        ],
      },
      {
        heading: "Prepare access and security before users arrive",
        paragraphs: [
          "Identity is often the front door to the new environment. Permissions, multi-factor authentication and device requirements should be designed before migration rather than added after users begin working.",
          "Test access with realistic user groups, including remote workers and people who depend on specialist applications. A technically successful login test may not reveal the full workflow.",
        ],
        points: [
          "User groups and permission models",
          "Multi-factor and conditional access",
          "Administrative roles and emergency access",
          "External sharing and guest users",
          "Device readiness and application compatibility",
        ],
      },
      {
        heading: "Sequence change around the working day",
        paragraphs: [
          "Migration planning should reflect how the organisation operates. Select pilot users who can provide useful feedback, avoid critical business periods and define the point at which the old and new environments become authoritative.",
          "Communication should explain what changes, what users need to do and where they can get help. Short, role-specific guidance is often more effective than a large generic manual.",
        ],
        points: [
          "Pilot with a representative user group.",
          "Use clear migration waves and decision gates.",
          "Plan rollback or recovery for important stages.",
          "Provide visible support during and after each wave.",
        ],
      },
      {
        heading: "Stabilise before declaring completion",
        paragraphs: [
          "The first successful day is not the end of the migration. Monitor recurring questions, access problems, performance and unexpected workflow changes. These signals show where configuration or guidance needs improvement.",
          "Close the project with updated ownership, documentation and a list of optimisation opportunities. This ensures the new cloud environment becomes an actively managed service rather than another collection of settings.",
        ],
      },
    ],
    takeaways: [
      "Tie the migration to a specific organisational outcome.",
      "Map technical and user dependencies before sequencing work.",
      "Move only what has a clear destination and purpose.",
      "Prepare identity, security and devices early.",
      "Use pilots, communication and post-migration stabilisation.",
    ],
  },
];
